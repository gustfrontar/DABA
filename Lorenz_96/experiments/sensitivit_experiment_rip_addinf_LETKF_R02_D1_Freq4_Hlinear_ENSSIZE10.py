...
out_filename='Sesitivity_experiment_rip_addinf_LETKF_' + conf.GeneralConf['NatureName'] + '_EnsSize10.npz'
...
conf.DAConf['NEns'] = 10                                  #Number of ensemble members
...
if RunTheExperiment  :
    ...
    for iinf , add_inf in enumerate( add_inf_range ) :
        for inrip , nrip in enumerate( nrip_range )  :
            ...
            print('Tempering iteraations',nrip)
