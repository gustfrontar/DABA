...
exp_filename='../npz/Sesitivity_experiment_tempering_grosserr_rtpp_LETKF_' + NatureName + '.npz'
...
plt.savefig('FigureAnalRMSE_Grosserror_RTPP_R1_Den1_Freq4_Hradar.png')
