...
GeneralConf['NatureName']='NatureR05_Den025_Freq8_Hlogaritmic'
...
DAConf['InfCoefs']=np.array([1.18,0.0,0.0,0.0,0.00])   #Mult inf, RTPS, RTPP, EPES, Additive inflation
...
DAConf['NTemp']=4                                    #Number of temper iterations 
...
DAConf['AddaptiveTemp']=False                         #Adaptive tempering.
