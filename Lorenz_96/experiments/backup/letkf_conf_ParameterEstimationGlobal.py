...
#In the ImperfectModel experiments, F parameter is set to 10 while 
#the true parameter value is 8. Note that the "Twin" flag is set to
#False.
#=================================================================
...
GeneralConf['DataPath']='./data/'               #Data output path
GeneralConf['FigPath']='./figs/'                #Figures output path
GeneralConf['RunSave']=True                     #Save the output
GeneralConf['LETKFFile']='LetkfRun.npz'         #Output file name
...
ModelConf['Coef']=np.array([7.5,0,0])                   #Coefficient of parametrized forcing (polynom coefficients starting from coef[0]*x^0 + coef[1]*x ... ) 
...
DAConf['InitialPSigma']=np.array([0.05,0,0])            #Initial ensemble spread for the parameters. (0 means no parameter estimation)
