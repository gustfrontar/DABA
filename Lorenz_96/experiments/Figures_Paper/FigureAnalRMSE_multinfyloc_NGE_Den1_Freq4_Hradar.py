...
exp_filename='../npz/Sesitivity_experiment_multinfyloc_LETKF_NGEC_' + NatureName + '.npz'
...
NatureName='NatureR03_Den1_Freq4_Hradar'
exp_filename='../npz/Sesitivity_experiment_multinfyloc_LETKF-T2_ptemp2.0_NGEC_' + NatureName + '.npz'
...
plt.savefig('FigureAnalRMSE_multinfyloc_NGE_Den1_Freq4_Hradar.png')
