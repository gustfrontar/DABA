...
da_exp['bridge']=0.5                             # Coeficiente de combiancion entre ETPF y ETKF. 0-ETKF puro, 1-ETPF puro.


filename = './Sensitivity_to_temperingiterations_R'+str(da_exp['R0'])+'_bst'+str(da_exp['bst'])+'_alpha'+str(da_exp['bridge'])+'_'+da_exp['obs_operator_name']+'.pkl'
