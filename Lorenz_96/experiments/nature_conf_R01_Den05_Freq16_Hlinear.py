...
GeneralConf['ExpName']='R01_Den05_Freq16_Hlinear'           #Experiment name.
...
NatureConf['Length']=2000                           #Nature run length in model time units (1 model time unit app. equivalent to 5 day time in the atmosphere)
...
ObsConf['Freq']=16                                    #Observation frequency in number of time steps (will also control nature run output frequency)

#Observation location
ObsConf['NetworkType']='regular'                     #Observation network type: REGULAR, RANDOM, FROMFILE

ObsConf['SpaceDensity']=0.5                          #Observation density in space. Usually from [0-1] but can be greather than 1.
...
ObsConf['Error']=0.1                                  #Constant observation error.
