...
for ii in range( xa1_x.size ) :
    for jj in range( xa1_y.size ) :
        #Nota, en este caso z no interviene en la observacion por lo tanto el calculo de la likehood es exacto. De lo contrario
        #habria que hacer la likelihood marginzalizada en x-y calculando para varios z y sumando.
        like_den[ii,jj] = np.exp( -2.0 * ( forward_operator( np.array([xa1_x[ii],xa1_y[jj],0]) ) - yo1 ) ** 2 )
...
plt.legend()
plt.savefig('Figure_update_ETKF_1step_nonlinearsum_' + str(bst) + '_' + str(numtrans) + '.png')
...
plt.title('Z')
plt.legend()
plt.savefig('Figure_marginal_dist_ETKF_1step_nonlinearsum_' + str(bst) + '_' + str(numtrans) + '.png')
...
plt.savefig('Figure_update_ETKF_tempering_nonlinearsum_' + str(bst) + '_' + str(numtrans) + '.png')
...
plt.title('Z')
plt.legend()
plt.savefig('Figure_marginal_dist_ETKF_tempering_nonlinearsum_' + str(bst) + '_' + str(numtrans) + '.png')
...
plt.savefig('Figure_update_ETKF_temperingexp_nonlinearsum_' + str(bst) + '_' + str(numtrans) + '.png')
...
plt.title('Z')
plt.legend()
plt.savefig('Figure_marginal_dist_ETKF_temperingexp_nonlinearsum_' + str(bst) + '_' + str(numtrans) + '.png')
...
plt.savefig('Figure_update_ETKF_rip_nonlinearsum_' + str(bst) + '_' + str(numtrans) + '.png')
...
plt.title('Z')
plt.legend()
plt.savefig('Figure_marginal_dist_ETKF_rip_nonlinearsum_' + str(bst) + '_' + str(numtrans) + '.png')
...
plt.savefig('Figure_update_ETKF_ripexp_nonlinearsum_' + str(bst) + '_' + str(numtrans) + '.png')
...
plt.title('Z')
plt.legend()
plt.savefig('Figure_marginal_dist_ETKF_ripexp_nonlinearsum_' + str(bst) + '_' + str(numtrans) + '.png')
...
plt.savefig('Figure_update_ETPF_1step_nonlinearsum_' + str(bst) + '_' + str(numtrans) + '.png')
...
plt.title('Z')
plt.legend()
plt.savefig('Figure_marginal_dist_ETPF_1step_nonlinearsum_' + str(bst) + '_' + str(numtrans) + '.png')
...
plt.savefig('Figure_update_ETPF_tempering_nonlinearsum_' + str(bst) + '_' + str(numtrans) + '.png')
...
plt.title('Z')
plt.legend()
plt.savefig('Figure_marginal_dist_ETPF_tempering_nonlinearsum_' + str(bst) + '_' + str(numtrans) + '.png')
...
plt.savefig('Figure_update_ETPF_temperingexp_nonlinearsum_' + str(bst) + '_' + str(numtrans) + '.png')
...
plt.title('Z')
plt.legend()
plt.savefig('Figure_marginal_dist_ETPF_temperingexp_nonlinearsum_' + str(bst) + '_' + str(numtrans) + '.png')
...
plt.savefig('Figure_update_ETPF_rip_nonlinearsum_' + str(bst) + '_' + str(numtrans) + '.png')
...
plt.title('Z')
plt.legend()
plt.savefig('Figure_marginal_dist_ETPF_rip_nonlinearsum_' + str(bst) + '_' + str(numtrans) + '.png')
...
plt.savefig('Figure_update_ETPF_ripexp_nonlinearsum_' + str(bst) + '_' + str(numtrans) + '.png')
...
plt.title('Z')
plt.legend()
plt.savefig('Figure_marginal_dist_ETPF_ripexp_nonlinearsum_' + str(bst) + '_' + str(numtrans) + '.png')
...
plt.savefig('Figure_update_HIB_1step_nonlinearsum_' + str(bst) + '_' + str(numtrans) + '.png')
...
plt.title('Z')
plt.legend()
plt.savefig('Figure_marginal_dist_HIB_1step_nonlinearsum_' + str(bst) + '_' + str(numtrans) + '.png')
...
plt.savefig('Figure_update_HIB_tempering_nonlinearsum_' + str(bst) + '_' + str(numtrans) + '.png')
...
plt.title('Z')
plt.legend()
plt.savefig('Figure_marginal_dist_HIB_tempering_nonlinearsum_' + str(bst) + '_' + str(numtrans) + '.png')
...
plt.savefig('Figure_update_HIB_temperingexp_nonlinearsum_' + str(bst) + '_' + str(numtrans) + '.png')
...
plt.title('Z')
plt.legend()
plt.savefig('Figure_marginal_dist_HIB_temperingexp_nonlinearsum_' + str(bst) + '_' + str(numtrans) + '.png')
...
plt.savefig('Figure_update_HIB_rip_nonlinearsum_' + str(bst) + '_' + str(numtrans) + '.png')
...
plt.title('Z')
plt.legend()
plt.savefig('Figure_marginal_dist_HIB_rip_nonlinearsum_' + str(bst) + '_' + str(numtrans) + '.png')
...
plt.savefig('Figure_update_HIB_ripexp_nonlinearsum_' + str(bst) + '_' + str(numtrans) + '.png')
...
plt.title('Z')
plt.legend()
plt.savefig('Figure_marginal_dist_HIB_ripexp_nonlinearsum_' + str(bst) + '_' + str(numtrans) + '.png')
...
tmp_for = np.copy( xf1_ens_da ) 
[ tmp_anal , tmp_anal_mean , null_var , null_var , null_var ] =da.analysis_update_GMDR( yo1 , tmp_for , forward_operator , R , beta_param , gamma_param  )
...
plt.savefig('Figure_update_GMDR_1step_nonlinearsum_' + str(bst) + '_' + str(numtrans) + '.png')
...
plt.title('Z')
plt.legend()
plt.savefig('Figure_marginal_dist_GMDR_1step_nonlinearsum_' + str(bst) + '_' + str(numtrans) + '.png')
...
x_ens_evol_gmdrt[:,:,0] = xf1_ens_da #El tiempo 0 son las particulas sampleadas del prior.

tmp_ftmp_for = np.copy( xf1_ens_da )
Rt = R * NTemp
for itemp in range(NTemp) : 
    [ tmp_for , tmp_anal_mean , null_var , null_var , null_var ] =da.analysis_update_GMDR( yo1 , tmp_for , forward_operator , R , beta_param , gamma_param  )
...
plt.savefig('Figure_update_GMDR_tempering_nonlinearsum_' + str(bst) + '_' + str(numtrans) + '.png')
...
plt.title('Z')
plt.legend()
plt.savefig('Figure_marginal_dist_GMDR_tempering_nonlinearsum_' + str(bst) + '_' + str(numtrans) + '.png')
...
plt.savefig('Figure_update_GMDR_temperingexp_nonlinearsum_' + str(bst) + '_' + str(numtrans) + '.png')
...
plt.title('Z')
plt.legend()
plt.savefig('Figure_marginal_dist_GMDR_temperingexp_nonlinearsum_' + str(bst) + '_' + str(numtrans) + '.png')
...
for irip in range(NRip) :
    ...
    tmp_ens[:,:,1] = model.forward_model( ne=EnsSize , x0=tmp_ens[:,:,0] , p=p , nt=bst , dt=dt  )
    [ tmp_ens[:,:,1] , tmp_anal_mean , null_var , null_var , null_var , tmp_ens[:,:,0] ] =da.analysis_update_GMDR_rip( yo1 , tmp_ens , forward_operator , Rt , beta_param , gamma_param  )
...
plt.savefig('Figure_update_GMDR_rip_nonlinearsum_' + str(bst) + '_' + str(numtrans) + '.png')
...
plt.title('Z')
plt.legend()
plt.savefig('Figure_marginal_dist_GMDR_rip_nonlinearsum_' + str(bst) + '_' + str(numtrans) + '.png')
...
plt.savefig('Figure_update_GMDR_ripexp_nonlinearsum_' + str(bst) + '_' + str(numtrans) + '.png')
...
plt.title('Z')
plt.legend()
plt.savefig('Figure_marginal_dist_GMDR_ripexp_nonlinearsum_' + str(bst) + '_' + str(numtrans) + '.png')
