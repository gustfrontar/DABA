...
plt.plot( analysis_sprd_orip[0][:,1] , analysis_rmse_orip[0][:,1] ,'g--')
plt.plot( analysis_sprd_orip[0][:,3] , analysis_rmse_orip[0][:,3] ,'r--')

#plt.ylim(bottom=2.4,top=3.5)
#plt.xlim(left=0.7,right=2.5)
plt.grid(axis='both')
...
plt.plot( analysis_sprd_orip[1][:,1] , analysis_rmse_orip[1][:,1] ,'g--')
plt.plot( analysis_sprd_orip[1][:,3] , analysis_rmse_orip[1][:,3] ,'r--')
...
plt.plot( analysis_sprd_orip[2][:,1] , analysis_rmse_orip[2][:,1] ,'g--')
plt.plot( analysis_sprd_orip[2][:,3] , analysis_rmse_orip[2][:,3] ,'r--')
...
plt.savefig('./Figura_sensibilidad_trip_orip_LETKF.png')
