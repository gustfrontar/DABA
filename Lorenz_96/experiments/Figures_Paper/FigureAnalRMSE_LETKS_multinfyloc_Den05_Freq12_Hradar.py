...
NatureName='NatureR03_Den05_Freq12_Hradar'
...
NatureName='NatureR1_Den05_Freq12_Hradar'
exp_filename='../npz/Sesitivity_experiment_multinfyloc_LETKF-T2_ptemp2.0_' + NatureName + '.npz'
...
NatureName='NatureR5_Den05_Freq12_Hradar'
exp_filename='../npz/Sesitivity_experiment_multinfyloc_LETKF-T2_ptemp2.0_' + NatureName + '.npz'
...
NatureName='NatureR25_Den05_Freq12_Hradar'
exp_filename='../npz/Sesitivity_experiment_multinfyloc_LETKF-T2_ptemp2.0_' + NatureName + '.npz'
...
plt.savefig('FigureAnalRMSE_LETKS_multinfyloc_Den05_Freq12_Hradar.png')
