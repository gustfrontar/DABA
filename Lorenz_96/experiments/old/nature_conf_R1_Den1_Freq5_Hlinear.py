...
GeneralConf['ExpName']='R1_Den1_Freq5_Hlinear'           #Experiment name.
...
ObsConf['Freq']=5                                    #Observation frequency in number of time steps (will also control nature run output frequency)
