...
conf.GeneralConf['NatureName']='NatureR4_Den05_Freq8_Hcuadratic'
out_filename='Sesitivity_experiment_addinf_HYBRID03_' + conf.GeneralConf['NatureName'] + '.npz'
#Define the source of the observations
conf.GeneralConf['ObsFile']='./data/Nature/'+conf.GeneralConf['NatureName']+'.npz'
    
conf.DAConf['ExpLength'] = 500                           #None use the full nature run experiment. Else use this length.
