...
for i in range(1,da_exp['numstep']) :
    ...
    [ da_exp['stateaens'][i,:,:] , da_exp['statea'][i,:] , da_exp['Pa'][i,:,:] , da_exp['OmB'][i,:] , da_exp['OmA'][i,:] , da_exp['w'][i,:] , S ] =da.analysis_update_EMD(da_exp['yobs'][i,:],da_exp['statefens'][i,:,:,0],forward_operator,da_exp['R'] ,da_exp['rtps_alpha'] , da_exp['rejuv_param'],da_exp['multinf'])
