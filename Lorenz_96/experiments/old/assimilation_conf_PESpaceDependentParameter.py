...
#The true parameter is space dependent following an armonic space dependence
#=================================================================

GeneralConf=dict()

GeneralConf['ExpName']='LETKF_PESpaceDependentParameter'                #Experiment name.
...
#in this file.
GeneralConf['ObsFile']='./data/Nature/NatureSpaceDependentParameter.npz'
...
DAConf['InfCoefsP']=np.array([1.015,0.0,0.0,0.0,0.0])  #Mult inf, RTPS, RTPP, EPES, Additive inflation
