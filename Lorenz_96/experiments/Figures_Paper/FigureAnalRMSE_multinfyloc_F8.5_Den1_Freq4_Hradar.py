...
exp_filename='../npz/Sesitivity_experiment_multinfyloc_LETKF_F8.5_' + NatureName + '.npz'
...
NatureName='NatureR03_Den1_Freq4_Hradar'
exp_filename='../npz/Sesitivity_experiment_multinfyloc_LETKF-T2_ptemp2.0_F8.5_' + NatureName + '.npz'
...
plt.savefig('FigureAnalRMSE_multinfyloc_F8.5_Den1_Freq4_Hradar.png')
