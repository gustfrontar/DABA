...
DAConf['InfCoefs']=np.array([1.0,0.0,0.0,0.0,0.15])   #Mult inf, RTPS, RTPP, EPES, Additive inflation
...
DAConf['BetaCoef']=0.7                                 #Scaling parameter for the Gaussian Kernel in the Gaussian mixture prior.
