...
conf.DAConf['GammaCoef']=1.0                                #Nudging parameter to uniform weigths in order to avoid weigth degeneracy. 
...
conf.DAConf['InfCoefs']=np.array([1.15,0.0,0.0,0.0,0.0])
conf.DAConf['RejuvParam']=0.0                               #Global particle rejuvenestion (For the ETPF only)
conf.DAConf['BridgeParam']=0.6 
conf.DAConf['EnableTempering']=True
conf.DAConf['GMSampleAmpFactor']=2

results =  gmetpf.assimilation_hybrid_run( conf ) 
