...
conf.GeneralConf['NatureName']='NatureR1_Den1_Freq4_Hquadratic'
out_filename='./npz/Sesitivity_experiment_ptemp3.0_multinf_LETKF_' + conf.GeneralConf['NatureName'] + '.npz'
...
conf.DAConf['AlphaTempScale'] = 3.0                       #Scale factor to obtain the tempering factors on each tempering iteration.
