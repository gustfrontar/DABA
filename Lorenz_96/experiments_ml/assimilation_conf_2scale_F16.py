...
GeneralConf['ExpName']='LETKF2scale_F16'                                #Experiment name.
...
#in this file.
GeneralConf['ObsFile']='./data/Nature/Nature2scale_F16.npz'
...
ModelConf['nx'] =  8                                   #Number of large-scale state variables
ModelConf['dt']  =0.0125                               #Time step for large-scale variables (do not change)

#Forcing section

ModelConf['Coef']=np.array([16.27,-1.04])                     #Coefficient of parametrized forcing (polynom coefficients starting from coef[0]*x^0 + coef[1]*x ... ) 
...
DAConf['InfCoefs']=np.array([1.5,0.0,0.0,0.0,0.0])   #Mult inf, RTPS, RTPP, EPES, Additive inflation , RejuvParameter
