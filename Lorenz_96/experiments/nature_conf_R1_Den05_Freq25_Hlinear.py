...
GeneralConf['ExpName']='R1_Den05_Freq25_Hlinear'           #Experiment name.
...
NatureConf['Length']=10000                           #Nature run length in model time units (1 model time unit app. equivalent to 5 day time in the atmosphere)
...
ObsConf['Freq']=25                                   #Observation frequency in number of time steps (will also control nature run output frequency)
...
ObsConf['Error']=1                                  #Constant observation error.
