...
import numpy as np
import time
import forecast_conf_DeterministicForecast as conf             #Load the experiment configuration
import os
...
NLeads=np.int( ForConf['ForecastLength'] / ObsConf['Freq'] + 1 )

#Compute the number of forecasts that will be performed.
NForecasts=XNature.shape[2] - ForConf['AnalysisSpinUp'] - NLeads
