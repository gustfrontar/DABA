...
GeneralConf['ExpName']='FastTimeDependentParameter'                  #Experiment name.
GeneralConf['DataPath']='./data/Nature/'                         #Data output path
GeneralConf['FigPath']='./figs/Nature/'                          #Figures output path
GeneralConf['NatureFileName']='NatureFastTimeDependentParameter.npz'
...
ModelConf['EnablePRF']=True                             #Activate Parameter random walk
ModelConf['CSigma']=np.array([0.1])                     #Parameter random walk sigma
ModelConf['CPhi'  ]=0.98                                #Parameter random walk phi
