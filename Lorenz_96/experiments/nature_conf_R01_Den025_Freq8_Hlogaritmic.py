...
GeneralConf['ExpName']='R01_Den025_Freq8_Hlogaritmic'       #Experiment name.
...
ObsConf['Freq']=8                                    #Observation frequency in number of time steps (will also control nature run output frequency)

#Observation location
ObsConf['NetworkType']='regular'                     #Observation network type: REGULAR, RANDOM, FROMFILE

ObsConf['SpaceDensity']=0.25                         #Observation density in space. Usually from [0-1] but can be greather than 1.
...
ObsConf['Type']=4                                    #Observation type (1 observ x, 2 observe x**2)
