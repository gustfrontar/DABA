...
p1=axs[0].plot(inf_range,total_analysis_rmse[:,0],label='EnKF ('+str(min_error[0])+')')
p2=axs[0].plot(inf_range,total_analysis_rmse[:,1],label='EnKF-T2 ('+str(min_error[1])+')')
p3=axs[0].plot(inf_range,total_analysis_rmse[:,2],label='EnKF-T3 ('+str(min_error[2])+')')
p4=axs[0].plot(inf_range,total_analysis_rmse[:,3],label='EnKF-T4 ('+str(min_error[3])+')')
axs[0].legend()
axs[0].grid()
axs[0].set_ylim([0,5])
