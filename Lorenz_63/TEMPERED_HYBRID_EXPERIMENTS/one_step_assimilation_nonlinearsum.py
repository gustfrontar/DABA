...
plt.savefig('Figure_update_ETKF_ripaddaptive_nonlinearsum_' + str(bst) + '_' + str(numtrans) + '.png')
...
plt.title('Z')
plt.legend()
plt.savefig('Figure_marginal_dist_ETKF_ripaddaptive_nonlinearsum_' + str(bst) + '_' + str(numtrans) + '.png')
...
plt.savefig('Figure_update_GPF_1step_nonlinearsum_' + str(bst) + '_' + str(numtrans) + '.png')
...
plt.legend()
plt.suptitle('GPF')
plt.savefig('Figure_marginal_dist_GPF_1step_nonlinearsum_' + str(bst) + '_' + str(numtrans) + '.png')
