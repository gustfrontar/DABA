...
out_filename='./npz/Sesitivity_experiment_tempering_grosserr_rtpp_LETKF_' + conf.GeneralConf['NatureName'] + '.npz'
...
conf.DAConf['InfCoefs']=np.array([1.0,0.0,0.0,0.65,0.0])  #Optimized multiplicative inflation for 1 tempering iteration.
