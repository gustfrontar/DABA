...
GeneralConf['ExpName']='Maxi'                             #Experiment name.
...
ModelConf['Coef']=np.array([40,0,0])                    #Coefficient of parametrized forcing (polynom coefficients starting from coef[0]*x^0 + coef[1]*x ... )
...
ModelConf['nxss']= ModelConf['nx'] * 64                 #Number of small scale variables
...
NatureConf['SPLength']=100                          #Spin up length in model time units (1 model time unit app. equivalent to 5 day time in the atmosphere)
NatureConf['Length']=200                            #Nature run length in model time units (1 model time unit app. equivalent to 5 day time in the atmosphere)
