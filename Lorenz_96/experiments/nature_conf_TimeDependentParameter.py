...
GeneralConf['ExpName']='TimeDependentParameter'                  #Experiment name.
GeneralConf['DataPath']='./data/Nature/'                         #Data output path
GeneralConf['FigPath']='./figs/Nature/'                          #Figures output path
GeneralConf['NatureFileName']='NatureTimeDependentParameter.npz'
...
ModelConf['CSigma']=np.array([0.05])                    #Parameter random walk sigma
ModelConf['CPhi'  ]=0.999                               #Parameter random walk phi
