...
#Tempering AND LETKF
#Different levels of non-linearity and different sources of non-linearity
#MY_EXP=sensitivit_experiment_tempering_multinf_LETKF_R4_D05_Freq8_Hlogaritmic_ModelError
#python -u ./${MY_EXP}.py compute  > ./logs/${MY_EXP}.log
...
#Adaptive Rip AND LETKF
#Different levels of non-linearity and different sources of non-linearity
#MY_EXP=sensitivit_experiment_adrip_multinf_LETKF_R4_D05_Freq8_Hlogaritmic_ModelError
#python -u ./${MY_EXP}.py compute  > ./logs/${MY_EXP}.log
...
#Adaptive tempering AND LETKF
#Different levels of non-linearity and different sources of non-linearity
MY_EXP=sensitivit_experiment_adtempering_multinf_LETKF_R4_D05_Freq8_Hlogaritmic_ModelError
python -u ./${MY_EXP}.py compute  > ./logs/${MY_EXP}.log
...
#Adaptive ORip AND LETKF
#Different levels of non-linearity and different sources of non-linearity
MY_EXP=sensitivit_experiment_orip_multinf_LETKF_R4_D05_Freq8_Hlogaritmic_ModelError
python -u ./${MY_EXP}.py compute  > ./logs/${MY_EXP}.log
