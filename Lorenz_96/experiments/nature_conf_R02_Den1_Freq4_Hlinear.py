...
GeneralConf['ExpName']='R02_Den1_Freq4_Hlinear'           #Experiment name.
...
NatureConf['Length']=500                           #Nature run length in model time units (1 model time unit app. equivalent to 5 day time in the atmosphere)
