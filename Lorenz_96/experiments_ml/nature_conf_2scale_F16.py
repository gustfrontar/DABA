...
GeneralConf['ExpName']='2scale_F16'                     #Experiment name.
...
#Forcing section
ModelConf['Coef']=np.array([16])                         #Coefficient of parametrized forcing (polynom coefficients starting from coef[0]*x^0 + coef[1]*x ... ) 
