...
GeneralConf['ExpName']='R5_Den025_Freq12_Hradar'           #Experiment name.
...
ObsConf['Freq']=12                                   #Observation frequency in number of time steps (will also control nature run output frequency)
...
ObsConf['Error']=25.0                                 #Constant observation error.
