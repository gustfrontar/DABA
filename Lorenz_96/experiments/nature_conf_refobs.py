...
GeneralConf['ExpName']='RefObs'                #Experiment name.
...
ObsConf['Error']=2.5                                 #Constant observation error.
...
ObsConf['Type']=3                                    #Observation type (1 observ x, 2 observe x**2, 3 observe psedu reflectivity)
