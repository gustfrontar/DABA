...
out_filename='./npz/Sesitivity_experiment_tempering_grosserr_rtps_LETKF_' + conf.GeneralConf['NatureName'] + '.npz'
...
conf.DAConf['InfCoefs']=np.array([1.0,0.0,0.65,0.0,0.0])  #Optimized multiplicative inflation for 1 tempering iteration.
...
conf.DAConf['GrossCheckFactor'] = 20.0                    #Optimized gross error check
...
if RunTheExperiment  :
    ...
    gross_error_check_range = np.arange( 1.0 , 25.0 , 1.0 )
