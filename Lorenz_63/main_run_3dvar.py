...
da_exp['pim']=np.array([9.0,27.0,b])
...
for i in range(1,da_exp['numstep']) :
    ...
    [ da_exp['statea'][i,:] , da_exp['OmB'][i,:] , da_exp['OmA'][i,:] ]=da.analysis_update_3DVAR(da_exp['yobs'][i,:],da_exp['statef'][i,:,0],da_exp['P0'],forward_operator,forward_operator_tl,da_exp['R']);
