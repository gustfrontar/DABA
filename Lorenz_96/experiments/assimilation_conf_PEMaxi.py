...
#=================================================================
#Parameter estimation Experiment 1
...
GeneralConf['ExpName']='LETKF_PEMaxi'                            #Experiment name.
...
#in this file.
GeneralConf['ObsFile']='./data/Nature/Nature_Maxi.npz'
...
ModelConf['Coef']=np.array([40,0])                     #Coefficient of parametrized forcing (polynom coefficients starting from coef[0]*x^0 + coef[1]*x ... ) 
...
DAConf['InfCoefsP']=np.array([1.05,0.0,0.0,0.0,0.0])  #Mult inf, RTPS, RTPP, EPES, Additive inflation
