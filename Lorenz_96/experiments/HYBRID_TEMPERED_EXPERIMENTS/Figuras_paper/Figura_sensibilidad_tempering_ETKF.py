...
file_list=['../../npz/Sesitivity_experiment_tempering_multinf_LETKF_NatureR4_Den05_Freq8_Hcuadratic.npz',
           '../../npz/Sesitivity_experiment_tempering_multinf_LETKF_NatureR4_Den05_Freq8_Hlogaritmic.npz',
           '../../npz/Sesitivity_experiment_tempering_multinf_LETKF_NatureR8_Den05_Freq8_Hlinear.npz']
...
#===========================================================================================================
#    LEO LOS EXPERIMENTOS DE TEMPERING ADAPTATIVO
#===========================================================================================================

file_list=['../../npz/Sesitivity_experiment_adtempering_multinf_LETKF_NatureR4_Den05_Freq8_Hcuadratic.npz',
           '../../npz/Sesitivity_experiment_adtempering_multinf_LETKF_NatureR4_Den05_Freq8_Hlogaritmic.npz',
           '../../npz/Sesitivity_experiment_adtempering_multinf_LETKF_NatureR8_Den05_Freq8_Hlinear.npz']
...
plt.plot( analysis_sprd_adtemp[0][:,1] , analysis_rmse_adtemp[0][:,1] ,'g--')
plt.plot( analysis_sprd_adtemp[0][:,3] , analysis_rmse_adtemp[0][:,3] ,'r--')
...
plt.plot( analysis_sprd_adtemp[1][:,1] , analysis_rmse_adtemp[1][:,1] ,'g--')
plt.plot( analysis_sprd_adtemp[1][:,3] , analysis_rmse_adtemp[1][:,3] ,'r--')
...
plt.plot( analysis_sprd_adtemp[2][:,1] , analysis_rmse_adtemp[2][:,1] ,'g--')
plt.plot( analysis_sprd_adtemp[2][:,3] , analysis_rmse_adtemp[2][:,3] ,'r--')
...
plt.savefig('./Figura_sensibilidad_tempering_ETKF.png')
