...
GeneralConf['ExpName']='LETKF_RefObs'                              #Experiment name.
...
#in this file.
GeneralConf['ObsFile']='./data/Nature/NatureRefObs.npz'
...
DAConf['NEns'] = 15                                  #Number of ensemble members
...
DAConf['InfCoefs']=np.array([1.15,0.0,0.0,0.0,0.0])   #Mult inf, RTPS, RTPP, EPES, Additive inflation
...
DAConf['InitialXSigma']=2                            #Initial ensemble spread for state variables.
...
DAConf['InfCoefsP']=np.array([1.25,1.0,0.0,0.0,0.0])  #Mult inf, RTPS, RTPP, EPES, Additive inflation
